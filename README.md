![Header_img](/public/imgs/header.png)
...
El avance de la realidad virtual (VR) ha revolucionado tanto el entretenimiento como los campos de investigación médica y psicológica, ofreciendo experiencias inmersivas que permiten evaluar y mejorar habilidades cognitivas y sensoriales en entornos seguros y controlados. Apoyada en dispositivos como los cascos de realidad virtual (HMD), esta tecnología logra una sensación de presencia total, permitiendo a los usuarios interactuar en entornos tridimensionales de manera eficaz. En especial, la VR ha demostrado ser útil en la evaluación de habilidades cognitivas, como la memoria espacial y la percepción de profundidad, además de beneficiar a personas con limitaciones visuales como la falta de estereopsis. Estudios recientes validan el uso de VR para entrenar habilidades sensoriales en entornos que simulan situaciones de la vida real, lo que sería difícil de replicar en el mundo físico [1][2].

En este proyecto, se ha desarrollado un juego de realidad virtual donde los usuarios deben defender la Tierra de una invasión de gatitos alienígenas, guiándose por el sonido tridimensional para atacarlos al ritmo adecuado. Además de mejorar reflejos y coordinación, el juego ofrece una innovadora herramienta médica para la evaluación de habilidades auditivas, visuales y de percepción espacial. En esta nueva versión, el juego también ha sido diseñado para ofrecer una experiencia de movimiento accesible a personas con estilos de vida sedentarios, falta de tiempo o timidez al ir a un gimnasio, proporcionando una forma divertida y eficaz de reducir el estrés y fomentar la actividad física en casa.
